defmodule OberonWeb.Router do
  ...
  pipeline :browser do
    ...
    plug :put_root_layout, html: {OberonWeb.Layouts, :root}
  ...
  # scope "/api", OberonWeb do
  #   pipe_through :api
  # end

  # Enable LiveDashboard and Swoosh mailbox preview in development
  if Application.compile_env(:oberon, :dev_routes) do
  ...
  scope "/", OberonWeb do
    ...
    live_session :current_user,
      on_mount: [{OberonWeb.UserAuth, :mount_current_scope}] do
